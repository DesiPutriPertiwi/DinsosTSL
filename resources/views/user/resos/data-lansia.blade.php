                                ...
                                <div class="container">
                                        <div class="header">
                                                <div class="entry-title" style="color:goldenrod">
                                                        <h2 style="text-shadow: 2px 2px 5px #ffc107">Daftar Nama Penerima Bandsos Uang Lanjut Usia 2018 Kota Tangerang Selatan</h2>
                                                        <p style="padding-top:30px">
                                                                Berupa daftar nama penerima bandsos uang lanjut usia (Lansia) Kota Tangerang Selatan.  
                                                        </p>
                                                </div><!-- entry-title -->
                                        </div><!-- header -->
                                        ...
                                        <div class="table100 ver2 m-b-110">
                                                <table data-vertable="ver2">
                                                        ...
                                                        <tbody>
                                                                @foreach($lansia as $index=>$lansias)
                                                                        <tr class="row100">
                                                                                <td class="column100 column2 text-center" data-column="column2">{{++$index}}</td>
                                                                                <td class="column100 column2" data-column="column2">{{$lansias->nama}}</td>
                                                                        </tr>
                                                                @endforeach
                                                        </tbody>
                                                </table>
