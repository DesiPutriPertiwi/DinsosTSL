                    ...
                    <div class="header">
                        <div class="entry-title" style="color:goldenrod">
                            ...
                            <p style="padding-top:30px">
                                Berupa data total kemiskinan dari berbagai kelurahan amupun kecamatan di Kota Tangerang Selatan. 
                            </p>
                        </div><!-- entry-title -->
                    </div><!-- header -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <figure class="featured-image">
                                    <a href="#" data-toggle="modal" data-target="#myModal"> <img src="data/resos/konten-kemiskinan.jpg" alt="fesival+celebration"> </a>
                            ...
                            <div class="modal" id="myModal">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <figure class="featured-image">
                                            <img src="data/resos/konten-kemiskinan.jpg" alt="fesival+celebration" style="center">
                                        </figure> <!--featured-image -->
