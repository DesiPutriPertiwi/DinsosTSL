                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                <figure class="featured-image" data-toggle="modal" data-target="#myModal2">
                                    <a href="#"> <img src="data/dayasos/rekap rinci kec kel.jpg" alt="fesival+celebration"> </a>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <figure class="featured-image">
                                            <img src="data/dayasos/rekap rinci kec kel.jpg" alt="fesival+celebration">
                                        </figure> <!--featured-image -->
                            ...
                            <!--Box 2.3-->
                            <div class="col-12 col-md-4">
                                <figure class="featured-image" data-toggle="modal" data-target="#myModal4">
                                    <a href="#" > <img src="data/dayasos/dayasos rinci kec kk.png" alt="fesival+celebration"> </a>
                                </figure><!-- featured-image -->

                                <div class="content-wrapper">
                                    <div class="entry-content">
                                        <div class="entry-header" data-toggle="modal" data-target="#myModal4">
                                            <h2>Rincian Hasil Verifikasi Validasi Kecamatan KK 2017</h2>
                                        </div><!-- entry-header -->
                                    </div><!-- entry-content -->
                                </div><!-- content-wrapper -->
                            </div><!-- .col-4 -->
                            ...
                            <div class="modal" id="myModal4">
                                ...
                                <div class="modal-content">
                                    ...
                                    <!-- Modal Header -->
                                    <div class="modal-header">
                                        <h4 class="modal-title">Rincian Hasil Verifikasi Validasi Kecamatan KK 2017</h4>
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <figure class="featured-image">
                                            <img src="data/dayasos/dayasos rinci kec kk.png" alt="fesival+celebration">
                                        </figure> <!--featured-image -->
